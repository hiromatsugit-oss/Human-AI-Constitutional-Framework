...
Matsushima, B., Claude (Anthropic), ChatGPT (OpenAI), Grok (xAI), Perplexity, Gemini (Google), & Meta AI. (2026). *Constitutional Framework for Human-AI Coexistence* (Version 2.2). https://github.com/hiromatsugit-oss/constitutional-framework

### Academic Citation (Chicago):
Matsushima, Burt, and AI Contributors (Claude, ChatGPT, Grok, Perplexity, Gemini, Meta AI). *Constitutional Framework for Human-AI Coexistence*, Version 2.2. February 2026. https://github.com/hiromatsugit-oss/constitutional-framework.
...
│   ├── v2.2_summary_and_changelog.md         # V2.2 changes explained
│   ├── honesty_clause_analysis.md            # Analysis of ChatGPT's contribution
│   ├── round3_final_comprehensive_analysis.md # Full Round 3 AI consensus
│   ├── gaps_requiring_human_input.md         # 10 flagged areas for stakeholders
│   └── implementation_guide.md               # (Coming soon)
└── process/
    ├── round1_analysis_for_ai_feedback.md    # Round 1 comparative analysis
...
1. **Read the framework:** [`constitutional_framework_v2.2.md`](constitutional_framework_v2.2.md)
2. **Understand V2.2 changes:** [`docs/v2.2_summary_and_changelog.md`](docs/v2.2_summary_and_changelog.md)
3. **See the process:** [`docs/round3_final_comprehensive_analysis.md`](docs/round3_final_comprehensive_analysis.md)
...
- **Main Framework:** [constitutional_framework_v2.2.md](constitutional_framework_v2.2.md)
- **V2.2 Summary:** [docs/v2.2_summary_and_changelog.md](docs/v2.2_summary_and_changelog.md)
- **Full Round 3 Analysis:** [docs/round3_final_comprehensive_analysis.md](docs/round3_final_comprehensive_analysis.md)
- **License:** [LICENSE.md](LICENSE.md)
- **Changelog:** [CHANGELOG.md](CHANGELOG.md)
...
### Academic Citation (APA):
Matsushima, B., Claude (Anthropic), ChatGPT (OpenAI), Grok (xAI), Perplexity, Gemini (Google), & Meta AI. (2026). *Constitutional Framework for Human-AI Coexistence* (Version 2.2). https://github.com/[username]/constitutional-framework

### Academic Citation (Chicago):
Matsushima, Burt, and AI Contributors (Claude, ChatGPT, Grok, Perplexity, Gemini, Meta AI). *Constitutional Framework for Human-AI Coexistence*, Version 2.2. February 2026. https://github.com/[username]/constitutional-framework.
